<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WishList.aspx.cs" Inherits="ShoppingTraditionz.Views.WishList" %>
...
<head runat="server">
	...
	<body>
		...
		<div class="container" style="margin-left: 70px;">
			...
			<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-hover well" id="example">
				<thead>
					<tr>
						<th>Product</th>
						<th>Description</th>
				...
				<tbody>
					<tr class="odd gradeX success">
						...
						<td class="center"><a href="" class="btn btn-link">Buy Now</a></td>
					</tr>
					<tr class="even gradeC success">
						<td><img class="wishlist-images" src="../img/toystory.jpg" alt="Product Name"></td>
						<td>lorem insum dollar sit amet</td>
						<td>1999</td>
						<td class="center">12-12-12</td>
					...
					<tr class="odd gradeA info">
						...
						<td>499</td>
						<td class="center">12-12-12</td>
						<td class="center">Coming soon</td>
						<td class="center"><a href="" class="btn btn-link disabled">Buy Now</a></td>
					</tr>
					<tr class="even gradeA error">
						<td><img class="wishlist-images" src="../img/up.jpg" alt="Product Name"></td>
						<td>lorem insum dollar sit amet</td>
						<td>499</td>
						<td class="center">12-12-12</td>
					...
					<tr class="odd gradeA error">
						<td><img class="wishlist-images" src="../img/walle.jpg" alt="Product Name"></td>
						<td>lorem insum dollar sit amet</td>
						<td>699</td>
						<td class="center">12-12-12</td>
						<td class="center">out of stock</td>
						<td class="center"><a href="" class="btn btn-link disabled">Buy Now</a></td>
					</tr><tr class="odd gradeX success">
						<td><img class="wishlist-images" src="../img/up.jpg" alt="Product Name"></td>
						<td>lorem insum dollar sit amet</td>
						<td>95</td>
						<td class="center">12-12-12</td>
