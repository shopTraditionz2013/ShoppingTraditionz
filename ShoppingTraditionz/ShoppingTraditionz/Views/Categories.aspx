<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Categories.aspx.cs" Inherits="ShoppingTraditionz.Views.Categories" %>
		...
		<header>
			<div class="container-fluid">
				<div class="row-fluid"><br/>
					<div class="span11">
						<div class="span3">
							<a href="Home.aspx"><img id="logo-img" src="../img/logo.jpg" alt="Logo" title="Fashion Traditions" /></a>
					    </div>
					    <div class="span9">
					    	<div class="span12">
								...
								<div id="loginModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="loginModalLabel" aria-hidden="true">
									<form id="login" class="form-horizontal" method="post" action="Home.aspx">
						...
						<div class="navbar">
							<div class="navbar-inner">
								<div class="container">
									...
									<a class="brand" href="Home.aspx">Home</a>
