<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TrackOrder.aspx.cs" Inherits="ShoppingTraditionz.Views.TrackOrder" %>
...
<head runat="server">
	...
	<body>
					    ...
					    <div class="span9">
					    	<div class="span12">
						    	<ul class="breadcrumb pull-right">
									...
									<li><a href="#">TRACK ORDER</a> <span class="divider">/</span></li>
		...
		<div class="container" style="margin-left: 70px;">
			...
			<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-hover well">
				<thead>
					<tr>
						<th>Order Id</th>
						<th>Products</th>
				...
				<tbody>
					<tr class="odd gradeX success">
						<td>OD123456789</td>
						<td>lorem insum dollar sit amet<br/>lorem <br/>ipsum dollar sit amet</td>
						<td>95</td>
						<td class="center">12-12-12</td>
						<td class="center">Delivered</td>
						<td class="center"><a href="" class="btn btn-link">View Details</a></td>
					</tr>
					<tr class="odd gradeX info">
						<td>OD123456789</td>
						<td>lorem insum dollar sit amet<br/>lorem ipsum dollar sit amet</td>
						<td>95</td>
						<td class="center">12-12-12</td>
						<td class="center">Work in Progress</td>
						<td class="center"><a href="" class="btn btn-link">View Details</a></td>
					</tr>
					<tr class="odd gradeX success">
						<td>OD123456789</td>
					...
					<tr class="odd gradeX error">
						<td>OD123456789</td>
						<td>lorem insum dollar sit amet<br/>lorem ipsum dollar sit amet</td>
						<td>95</td>
						<td class="center">12-12-12</td>
						<td class="center">Undelivered</td>
						<td class="center"><a href="" class="btn btn-link">View Details</a></td>
					</tr>
					<tr class="odd gradeX error">
						<td>OD123456789</td>
